		...
		for (int i = 0; i < runs; i++)
		{
			switch (rand.nextInt(9))
			{
				case 0:
					...
					jSize = j.size();
					if (aSize != jSize)
						System.out.println("a.size(): " + aSize + " j.size(): " + jSize);
					if (outputMethodCalls)
						System.out.println();
					break;
				...
				case 1:
					...
					if (!aGet.equals(jGet))
						System.out.println("a.get(" + getIndex + "): " + aGet + " j.get(" + getIndex + "): " + jGet);
					if (outputMethodCalls)
						System.out.println();
					break;
				...
				case 2:
					...
					if (!aSet.equals(jSet))
						System.out.println("a.set(" + setIndex + ", " + setValue + "): " + aSet + " j.set(" + setIndex + ", " + setValue + "): " + jSet);
					if (outputMethodCalls)
						System.out.println();
					break;
				...
				case 3:
					...
					if (aContains != jContains)
						System.out.println("a.contains(" + containsValue + "): " + aContains + " j.contains(" + containsValue + "): " + jContains);
					if (outputMethodCalls)
						System.out.println();
					break;
			 ...
			 break;
				...
				case 7:
					...
					if (aThrowsException != jThrowsException)
						System.out.println("a.add(" + addIndex + ", " + addValue1 + ") (throws exception): " + aThrowsException + " j.add(" + addIndex + ", "
				...
				case 8:
					...
					if (!aRemove.equals(jRemove))
						System.out.println("a.remove(" + removeIndex + "): " + aRemove + " j.remove(" + removeIndex + "): " + jRemove);
					if (outputMethodCalls)
						System.out.println();
					break;
				...
				case 9:
					...
					if (aRemoveResult != jRemoveResult)
						System.out.println("a.remove(new Integer(" + removeObject + ")): " + aRemoveResult + " j.remove(new Integer(" + removeObject + ")): "
								+ jRemoveResult);
					if (outputMethodCalls)
						System.out.println();
					break;
