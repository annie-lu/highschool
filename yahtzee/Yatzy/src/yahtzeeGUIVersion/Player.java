...
public class Player {
	...
	/**
	 * adds 50 points to yahtzeeBonus instance field
	 */
	...
	/**
	 * @return the amount of points in the Yahtzee section
	 */
	public int getYahtzee() {
		return lowerSection[6];
	}
	
	/**
	 * @return yahtzeeBonus the amount of yahtzee bonus points
	 */
